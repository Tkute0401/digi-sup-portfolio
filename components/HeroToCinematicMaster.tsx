...
const cinematicReels = [
  { id: 3, src: "/videos/all/cinematic_ARTHENIC_LUXE__INTRO_.mp4" },
  { id: 5, src: "/videos/all/cinematic_ARTHENIC_LUXE__REEL_3.mp4" },
  { id: 7, src: "/videos/all/cinematic_ARTHENIC_LUXE__REEL_5_.mp4" },
  { id: 9, src: "/videos/all/cinematic_ARTHENIC_LUXE__REEL_6_.mp4" },
  { id: 11, src: "/videos/all/cinematic_coming_soon_june.mp4" },
  { id: 12, src: "/videos/all/cinematic_styaling_spacio_june_05.mp4" },
  { id: 14, src: "/videos/all/cinematic_swadyog-jun-01.mp4" },
  { id: 16, src: "/videos/all/cinematic_swadyog-jun-02.mp4" },
  { id: 17, src: "/videos/all/cinematic_swadyog-jun-03.mp4" },
  { id: 18, src: "/videos/all/cinematic_unlimited_aamaras_swadyog.mp4" },
  { id: 19, src: "/videos/all/cinematic_ARTHENIC_LUXE__REEL_3_.mp4" },
];
    ...
    <div id="work" ref={masterContainerRef} className="relative w-full h-screen overflow-hidden bg-black text-white">
      ...
      <div ref={heroSectionRef} className="absolute inset-0 flex items-center justify-center z-10">
        ...
        >
          ...
          <h1 className="font-display font-black text-[12vw] md:text-[15vw] leading-[0.8] tracking-tighter uppercase whitespace-nowrap italic opacity-90">
            Supremacy
          </h1>
        </div>
