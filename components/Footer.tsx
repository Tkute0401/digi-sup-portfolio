...
export function Footer() {
  return (
    <footer id="contact" className="w-full bg-black text-white pt-40 pb-12 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-4">
        <h2 className="font-display font-black text-[18vw] uppercase tracking-tighter leading-[0.75] mb-16 text-transparent text-stroke hover:text-white transition-colors duration-700 cursor-none">
          Let's<br />Talk
        </h2>
        ...
        <div className="mt-40 w-full px-8 md:px-16 flex flex-col md:flex-row justify-between items-center text-[10px] md:text-xs font-sans uppercase tracking-[0.2em] opacity-50">
          <p>© 2026 DIGITAL SUPREMACY.</p>
