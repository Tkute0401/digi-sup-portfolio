...
const educationalReels = [
  { id: 1, src: "/videos/all/talkinghead_ROHIT_SARAF__6994_.mp4" },
  { id: 2, src: "/videos/all/talkinghead_TRADEHUB_JUNE__REEL_1___1_.mp4" },
  { id: 4, src: "/videos/all/talkinghead_TRADEHUB_JUNE__REEL_2___1_.mp4" },
  { id: 6, src: "/videos/all/talkinghead_rs_reel_6990.mp4" },
  { id: 8, src: "/videos/all/talkinghead_stayling-spacio-002.mp4" },
  { id: 10, src: "/videos/all/talkinghead_stayling-spacio-01.mp4" },
  { id: 13, src: "/videos/all/talkinghead_tradehub__reel1__1.mp4" },
];
...
export function EducationalStack() {
  ...
  return (
    <section id="services" ref={containerRef} className="relative w-full bg-zinc-950 text-white pb-[10vh] md:pb-[30vh]">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 w-full max-w-[1400px] mx-auto pt-16 md:pt-32 px-4 md:px-12 relative">
        ...
        <div className="col-span-1 lg:col-span-5 relative h-full hidden lg:block">
          <div className="sticky top-1/3">
            ...
            <p className="font-sans text-base font-light text-zinc-400 mt-8 max-w-sm leading-relaxed">
              Authority built on camera. High-converting talking head ads engineered for audience retention, deep conversion, and ultimate brand trust.
            </p>
        ...
        <div className="col-span-1 block lg:hidden">
          ...
          <p className="font-sans text-sm font-light text-zinc-400 mt-4 leading-relaxed max-w-sm">
            Authority built on camera. High-converting talking head ads engineered for retention.
          </p>
        </div>

        {/* Right: The Physical Stack */}
        <div className="col-span-1 lg:col-span-7 relative flex flex-col gap-[10vh] md:gap-[40vh] pb-[10vh] md:pb-[20vh] pt-4 lg:pt-[10vh]">
